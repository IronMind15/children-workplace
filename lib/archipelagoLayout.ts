...
export const ARCHIPELAGO_COORDS: Record<string, ArchipelagoCoord> = {
  ...
  // 4 · 图形与几何 · 立体与变换
  "MK-19": { x: 18, y: 28 }, "MK-20": { x: 50, y: 18 },
  "MK-21": { x: 18, y: 72 }, "MK-07": { x: 82, y: 72 },

  // 5 · 统计与概率
  "MK-24": { x: 22, y: 28 }, "MK-25": { x: 75, y: 25 },
  "MK-26": { x: 28, y: 72 }, "MK-27": { x: 78, y: 70 },
  ...
  // 7 · 量与测量 + 数学广角
  "MK-22": { x: 22, y: 30 }, "MK-23": { x: 78, y: 28 }, "MK-28": { x: 35, y: 72 },
};
