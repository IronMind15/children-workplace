  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pt-5 lg:px-8">
      ...
      <div className="mt-4 flex items-start gap-3">
        <div className="relative flex h-20 w-20 shrink-0 items-center justify-center rounded-xl border-4 border-[#2b3a4a] bg-[#fff8e1] text-5xl shadow-[0_5px_0_rgba(43,58,74,0.25)]">
          🦊
          {gainSpark && (
        ...
        <div className="pixel-panel-dark relative min-h-[110px] flex-1 p-4">
          {loading ? (
            ...
            <div className="animate-pop">
              ...
              <p className="mt-2 text-base font-bold leading-relaxed text-white">{answer}</p>
              <p className="mt-2 text-xs font-semibold text-white/60">🦊 想知道更多？继续问我，或者把答案讲给爸爸妈妈听！</p>
            </div>
          ) : (
